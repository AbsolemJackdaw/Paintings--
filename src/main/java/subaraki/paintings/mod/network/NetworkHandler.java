...
import subaraki.paintings.mod.network.CPacketNotifyTemplate.CPacketNotifyTemplateHandler;
...
public class NetworkHandler {
	...
	public NetworkHandler() {
		...
		NETWORK.registerMessage(CPacketNotifyTemplateHandler.class, CPacketNotifyTemplate.class, 1, Side.CLIENT);
