...
public class PlacePaintingEventHandler {
    ...
    public static void onPaintingPlaced(PlayerInteractEvent.RightClickBlock event) {
        ...
        PlacementPacketSupplier SENDER = (serverPlayer, painting, names) -> NetworkHandler.NETWORK.send(PacketDistributor.PLAYER.with((() -> serverPlayer)), new CPacketPainting(painting, names));
